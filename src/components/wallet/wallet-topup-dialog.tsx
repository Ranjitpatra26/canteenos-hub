          ...
          <AnimatePresence mode="wait">
            {step === "select" && (
              ...
              >
                ...
                <div>
                  <Label className="text-xs font-semibold text-muted-foreground">Choose Payment Gateway</Label>
            ...
            {step === "auth" && (
              ...
              >
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button type="button" onClick={handleConfirmPin} className="flex-2 rounded-xl text-xs gap-1.5">
                    Authorize Payment
                  </Button>
                </div>
              </motion.div>
            ...
            {step === "processing" && (
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-base">Verifying with Bank…</h3>
                  <p className="text-xs text-muted-foreground mt-1">
                    256-Bit Encrypted Handshake with {method.toUpperCase()} Payment Gateway.
                  </p>
                </div>
              </motion.div>
            )}
            ...
            {step === "success" && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Your campus wallet has been updated. You can now use your balance to buy food instantly!
                  </p>
                </div>
