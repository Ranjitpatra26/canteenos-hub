create policy "menu_images_read" on storage.objects for select to authenticated
  using (bucket_id = 'menu-images');
create policy "menu_images_admin_write" on storage.objects for insert to authenticated
